...
- I think that the default âradii proportional to countsâ is generally best, but this is not always obvious. The scale certainly makes a big difference however.
```{r eval=FALSE}
...
- Wish to generate a random âdirectionâ in d-dimensions; i.e., an observation from the uniform distribution in the $d-1$ sphere.
- Usual way: let $X â¼ N_d(0, I)$ and return $U = X/||X||$.
...
## Easy fix for Borelâs paradox in 3-d
